...
// Semaphore for STM
const char *STM_SEM = "stm_mutex664496651";



// Shared End Memory Key
#define SEM_KEY 0x1478
...
// Semaphore for SEM
const char *SEM_SEM = "sem_mutex342";




// Shared Queue Size Memory Key
#define SQSM_KEY 0x1465
...
// Semaphore for SQSM
const char *SQSM_SEM = "sqsm_mutex133";
...
// Semaphore for STPM
const char *STPM_SEM = "stpm_mutex4244";
